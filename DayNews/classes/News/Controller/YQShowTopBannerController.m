...
@interface YQShowTopBannerController ()<UIScrollViewDelegate>

@property (nonatomic , weak) UIScrollView *scroll;
@property (nonatomic , weak) UILabel *titleLabel;
@property (nonatomic , weak) UILabel *countLabel;
@property (nonatomic , weak) UITextView *textview;
@property (nonatomic , strong) YQTopBannerDaTa *topdata;
...
@implementation YQShowTopBannerController
...
-(void)initUI
{
    UIScrollView *scroll = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 20, YQSCREEN_WIDTH, YQSCREEN_HEIGHT - 49 - 20)];
    ...
    downbtn.frame = CGRectMake(YQSCREEN_WIDTH - 5 - 40, backbtn.frame.origin.y, 40, 40);
    ...
    titleLabel.frame = CGRectMake(5, YQSCREEN_HEIGHT - 70 - 49, YQSCREEN_WIDTH - 55, 20);
    ...
    //内容
    UITextView *textview = [[UITextView alloc]initWithFrame:CGRectMake(5, CGRectGetMaxY(titleLabel.frame), YQSCREEN_WIDTH - 15, 60)];
...
- (void)initNetWork
{
    IMP_BLOCK_SELF(YQShowTopBannerController);
    
    [[YQRequestTool shareRequestTool] setupRequestWithParameters:nil getPath:_url sussce:^(id responseObject) {
        block_self.count = [responseObject[@"imgsum"]intValue];
        block_self.setname = responseObject[@"setname"];
        
        NSArray *dataarray = [YQTopBannerDaTa mj_objectArrayWithKeyValuesArray:responseObject[@"photos"]];
        // 创建frame模型对象
