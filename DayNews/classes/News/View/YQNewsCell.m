...
@implementation YQNewsCell

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"newscell";
    YQNewsCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    if (cell == nil) {
        cell = [[YQNewsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(imageV.frame)+10, 10, YQSCREEN_WIDTH-CGRectGetMaxX(imageV.frame)-20, 40)];
        ...
        UILabel *scrL = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(imageV.frame)+10, CGRectGetMaxY(label.frame), YQSCREEN_WIDTH-CGRectGetMaxX(imageV.frame)-20, 40)];
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(10, 79, YQSCREEN_WIDTH - 20, 1)];
